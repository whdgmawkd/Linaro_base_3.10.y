...
extern int SIOP_INPUT_LIMIT_CURRENT_VAL;
extern int SIOP_CHARGING_LIMIT_CURRENT_VAL;
...
struct dev_ext_attribute static_controls[] = {
	CHARGE_INT_ATTR(siop_input_limit, 0644, SIOP_INPUT_LIMIT_CURRENT_VAL),
	CHARGE_INT_ATTR(siop_charge_limit, 0644, SIOP_CHARGING_LIMIT_CURRENT_VAL),
